...
extension GPSpecial{
    final class ViewModelGP1: ObservableObject{
        @Published var isActive = false
        @Published var showingAlerts = false
        @Published var time: String = "8:00"
        @Published var setTime: Float = 8.0
        @Published var minutes: Float = 8.0 {
            didSet{
