...
extension FiftyTwo{
    final class ViewModel52: ObservableObject{
        @Published var isActive = false
        @Published var showingAlerts = false
        @Published var rounds = 1
        @Published var currRound = 0
        @Published var time: String = "52:00"
        @Published var setTime: Float = 52.0 
        @Published var minutes: Float = 52.0 {
            didSet{
